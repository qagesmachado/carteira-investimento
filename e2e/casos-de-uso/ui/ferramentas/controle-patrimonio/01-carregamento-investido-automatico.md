...
- **Arquivo de teste:** `e2e/specs/controle-patrimonio/01-carregamento-investido-automatico.spec.ts`
...
1. Abro `/controle-patrimonio` com carteira seed (100 × R$ 10 = R$ 1.000).
