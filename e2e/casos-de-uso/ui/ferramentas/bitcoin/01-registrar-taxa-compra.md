...
- **ID:** `UI-BTC-001`
- **Status:** aprovado
- **Página:** `/ferramentas/bitcoin`
- **Funcionalidade:** cadastro de taxa e total no resumo
- **Depende de:** carteira com posição BTC-USD (seed API)
- **Arquivo de teste:** `e2e/specs/ferramentas/bitcoin/01-registrar-taxa-compra.spec.ts`
...
2. Abro `/ferramentas/bitcoin` — cards exibem posição e total de taxas.
