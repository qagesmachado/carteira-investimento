...
- **ID:** `UI-FERR-009`
- **Status:** aprovado
- **Página:** `/ferramentas/calculo-preco-medio`
- **Funcionalidade:** Lote 1 a partir de posição existente
- **Depende de:** carteira seed com BBSE3 (100 cotas @ R$ 32,50)
- **Arquivo de teste:** `e2e/specs/ferramentas/calculo-preco-medio/02-preenchimento-carteira.spec.ts`
...
2. Abro `/ferramentas/calculo-preco-medio` na aba **Com posição da carteira**.
