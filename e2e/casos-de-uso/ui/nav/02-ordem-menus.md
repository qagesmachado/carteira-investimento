...
1. Abro o menu **Alocação**.
2. Contém apenas **Rebalanceamento** e **Análise de ativos**.
3. Não contém mais «Objetivos» nem «Bitcoin».
...
- Itens de dropdown ficam visíveis após clicar no gatilho do menu.
